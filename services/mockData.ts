...
import { Job, JobCategory, JobStatus, RewardType, Visibility, FileVisibility, Application, UserRole, ApplicantProfile } from '../types';
...
export const MOCK_JOBS: Job[] = [
    ...
    },
    {
        ...
        description: 'We require a Math teacher for 5th class. It will be a contract base job.',
    ...
    },
    {
        ...
        description: 'Help clear the community garden beds and prepare them for spring planting. Tools will be provided.',
...
export const MOCK_APPLICATIONS: Application[] = [
    {
        ...
        coverLetter: 'I have expertise and experience as a Math teacher for 5 years. I am very keen to join this role.',
        availability: 'As per your job you required a teacher for 4 hours. But I am available for 3 hours.'
    },
    {
        id: 'app2',
        jobId: '2',
...
export const INITIAL_USER: ApplicantProfile = {
  ...
  about: 'I am an enthusiastic staff member looking to connect students with opportunities.',
  skills: [],
  experience: []
};
