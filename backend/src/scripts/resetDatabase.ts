  ...
  try {
    ...
    const sampleTasks = [
      // Pending Internal Task (School Admin/Task Manager can approve)
      {
        ...
        hoursRequired: 5,
        applicationOpenDate: new Date("2026-02-10"),
        applicationCloseDate: new Date("2026-03-10"),
      ...
      // Pending Central task (only Super Admin can approve cross-organisation)
      {
        ...
        hoursRequired: 3,
        applicationOpenDate: new Date("2026-02-15"),
        applicationCloseDate: new Date("2026-02-15"),
      ...
      // Published Internal Task (Visible to org members only)
      {
        ...
        hoursRequired: 10,
        applicationOpenDate: new Date("2026-02-08"),
        applicationCloseDate: new Date("2026-04-08"),
      ...
      // Published Central task (visible college-wide)
      {
        ...
        applicationCloseDate: new Date("2026-03-01"),
      ...
      // Another Pending Internal Task
      {
        ...
        hoursRequired: 8,
        applicationOpenDate: new Date("2026-02-12"),
        applicationCloseDate: new Date("2026-05-12"),
      ...
      // Published Central task created by Super Admin
      {
        ...
        hoursRequired: 4,
        applicationOpenDate: new Date("2026-02-20"),
        applicationCloseDate: new Date("2026-02-20"),
        selectionCriteria:
