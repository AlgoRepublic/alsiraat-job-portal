        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="md:hidden">
            <button
              ...
              className="p-2 text-red-900 rounded-xl transition-colors"
            >
              {showMobileMenu ? (
                <X className="w-7 h-7" />
              ) : (
          ...
          <div className="flex items-center gap-4">
            <button
              onClick={onGetStarted}
              className="hidden md:block text-gray-700 font-bold text-sm px-4"
            >
              Log in
            </button>
            <button
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-500">
                <li>
                  <button onClick={onGetStarted}>Marketplace</button>
                </li>
                <li>
                  <button onClick={onGetStarted}>Task Boards</button>
                </li>
                <li>
                  <button onClick={onGetStarted}>API Access</button>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-4 text-sm text-gray-500">
                <li>
                  <button onClick={onGetStarted}>About</button>
                </li>
                <li>
                  <button onClick={onGetStarted}>Careers</button>
                </li>
                <li>
                  <button onClick={onGetStarted}>Support</button>
                </li>
              </ul>
            </div>
            <div>
