        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div className="flex items-center justify-between text-[10px]">
            <label className="flex items-center space-x-2 cursor-pointer">
              <input
                type="checkbox"
                className="rounded-md border-zinc-300 text-red-900 focus:ring-red-900"
              />
            ...
            <Link
              to="/forgot-password"
              className="font-black text-red-900 dark:text-red-400 hover:underline uppercase tracking-widest"
            >
              Access Support?
            </Link>
          </div>
